...
const { client, isLoading, isError, clientMutation, updateClient, isUpdating, isUpdatingSuccess } = useClient( +route.params.id )
...
<template>
    ...
    <div v-if="client">
      ...
      <form @submit.prevent="updateClient(client!)">
        ...
        <br>
        <button type="submit" :disabled="isUpdating"> Guarda </button>
      </form>
